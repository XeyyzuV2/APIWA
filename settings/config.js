      ...
      endpoints: [
        {
          ...
          parameters: [{ name: "url", type: "string", required: true, description: "The URL of the TikTok video." }],
          versions: ["v2"],
        },
        {
          method: "GET",
          path: "/tools/downloader/instagram",
          description: "Download a video from an Instagram URL.",
          mediaType: "application/json",
          parameters: [{ name: "url", type: "string", required: true, description: "The URL of the Instagram post." }],
          versions: ["v2"],
        },
        {
          method: "GET",
          path: "/tools/downloader/x",
          description: "Download a video from an X (Twitter) URL.",
          mediaType: "application/json",
          parameters: [{ name: "url", type: "string", required: true, description: "The URL of the X (Twitter) post." }],
          versions: ["v2"],
        },
      ],
    },
